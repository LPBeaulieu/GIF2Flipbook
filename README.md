...
- <b>For best results, generate flipbooks from 5 to 6 second video clips, with an fps of 25. This results in flipbooks of a thickness of around 3-4 cm (1.2-1.5 inch) when printed on 24 lb multipurpose paper, which is a manageable thickness for optimal page flicking. A minimum weight of 24 lb should be used when printing on inkjet printers, so as to minimize any ink bleeding onto the other side of the page, as the flipbooks are to be printed in duplex mode when more than 4 flipbooks are generated at a time. Also, when printing flipbooks on laser printers, the toner density setting may need to be decreased to avoid printing too dark.</b>
